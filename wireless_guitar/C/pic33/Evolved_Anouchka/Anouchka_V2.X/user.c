...
T1CONbits.TON = 0;      //bit 15 TON: Timer1 On bit (1)
//1 = Starts 16-bit Timer1
//0 = Stops 16-bit Timer1
T1CONbits.TSIDL = 0;    //bit 13 TSIDL: Timer1 Stop in Idle Mode bit
//1 = Discontinues module operation when device enters Idle mode
//0 = Continues module operation in Idle mode
T1CONbits.TGATE = 0;    //bit 6 TGATE: Timer1 Gated Time Accumulation Enable bit
//When TCS = 1:
// This bit is ignored.
//When TCS = 0:
// 1 = Gated time accumulation is enabled
// 0 = Gated time accumulation is disabled
T1CONbits.TCKPS = 0b11; //bit 5-4 TCKPS<1:0>: Timer1 Input Clock Prescale Select bits
//11 = 1:256
//10 = 1:64
//01 = 1:8
//00 = 1:1
T1CONbits.TSYNC = 0;    //bit 2 TSYNC: Timer1 External Clock Input Synchronization Select bit (1)
//When TCS = 1:
// 1 = Synchronizes external clock input
// 0 = Does not synchronize external clock input
//When TCS = 0:
// This bit is ignored.
T1CONbits.TCS = 0;      //bit 1 TCS: Timer1 Clock Source Select bit (1)
//1 = External clock is from pin, T1CK (on the rising edge)
//0 = Internal clock (F P )
...
void InitPwm1(void) {
    ...
    PWMCON1bits.IUE = 1;    // Updates to the active MDC/PDCx/SDCx/DTRx/ALTDTRx/PHASEx/SPHASEx registers are immediate
